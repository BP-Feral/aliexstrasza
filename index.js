...
client.on("message", async msg => {
  ...
  if ( command === "sum" && msg.author.id === "268746806521888768") {
   ...
   if ( command === "txt" && msg.author.id === "268746806521888768") {
	...
	.addBlankField()
	.addField('[01] @Genin','lol',false)
     	.addField('[02] @Chunin','lol',false)
     	.addField('[03] @Jonin','lol',false)
     	.addField('[04] @Anbu','lol',false)
     	.addField('[05] @Rogue')
     	.addField('[06] @Jhinchuriki')
     	.addField('[07] @Edo Tensei')
     	.addField('[08] @Kage')
     	.addField('[09] @Sannin')
     	.addField('[10] @Sage')
     	.addField('[11] @God of Shinobi')
     	.addField('[12] @Jūbi')
     	.addField('[13] @8 Gates')
     	.addField('[14] @♔ Ōtsutsuki ♔')
	.addBlankField()
